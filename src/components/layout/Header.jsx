...
const ROUTE_META = [
  ...
  { match: '/accounting/setup', titleKey: 'routes.accountingSetup', sectionKey: 'sections.accounting' },
  ...
  { match: '/accounting/pending', titleKey: 'routes.accountingPending', sectionKey: 'sections.accounting' },
  ...
  { match: '/accounting/settings', titleKey: 'routes.accountingSettings', sectionKey: 'sections.accounting' },
  { match: '/accounting/audit', titleKey: 'routes.accountingAudit', sectionKey: 'sections.accounting' },
